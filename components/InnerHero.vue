...
<template>
    <section class="relative flex flex-col justify-center items-center -mt-[40px] md:h-[90vh] min-h-[70vh]">
        <NuxtImg :src="pagebanner" :alt="'AITS' + pagetitle" width="1140" height="718" center cover responsive loading="eager" class="absolute inset-0 w-full h-full aspect-[1.59/1]"/>
        <div class="absolute w-11/12 mx-auto md:transform md:-translate-y-1/2 md:top-1/2 z-[1] 2xl:w-8/12 lg:w-10/12 top-2/3 -translate-y-2/3">
            <div class="md:h-[85%] min-h-[40vh] space-y-6 rounded-[16px] flex flex-col justify-center p-6 items-center mx-auto bg-gradient-to-r from-accent1/10 to-accent1/20 backdrop-blur-[16px]">
                ...
                <!-- <NuxtLink v-if="isIndustries" id="go-to-contact-page" aria-label="go to contact page" to="/contact" class="block relative z-[2] cursor-pointer px-4 py-3 max-sm:text-[14px] font-[200] text-center rounded-[8px] text-accent1 bg-bg2 hover:brightness-125">Discover Our Solutions</NuxtLink> -->
            </div>
        </div>
        <!-- Highlights -->
            <!-- top left -->
